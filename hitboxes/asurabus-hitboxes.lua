...
-------------------------------------
-- Draw Afterimage Boxes

--Hitbox 1
if (Char == 0 or Char == 3 or Char == 8) and Boost == 1 then --Are you Alice?
	if DMW_ATKState > 0 and DMW_Facing == 1 then
		gui.box(
		DMW_XPos_SCR+DMW_A1_XR-1,
		0+(DMW_YPos_SCR)+DMW_A1_YT-1,
...
DMW_C1_XR=rws(0x00405A1A)	--Hitbox 2
