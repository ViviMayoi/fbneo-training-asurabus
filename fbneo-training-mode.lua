...
local games = {
	...
	asurabus = { "asurabus", hitboxes = "asurabus-hitboxes", iconfile = "icons-asurabus-32.png" },
...
do -- file checking logic + global variables/tables
	...
	checkAvailableFunctions = function() -- SETUP availablefunctions TABLE
		...
		if RunBefore then availablefunctions.runbefore = true end
...
setRegisters = function() -- pre-calc stuff
	...
	if availablefunctions.runbefore then
		table.insert(registers.registerbefore, RunBefore)
	else
